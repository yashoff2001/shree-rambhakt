        ...
        <div className="rounded-2xl p-7 shadow-2xl h-[fit-content]" id='menuSection'>
            ...
            <form ref={form} onSubmit={sendEmail} className="space-y-7">
                ...
                <div className="flex flex-col md:flex-row gap-7">
                    ...
                    <div className="flex flex-col gap-3">
                        ...
                        <select name="subject" value={formData.subject} onChange={handleChange} className="border-2 border-zinc-200 focus:border-slate-800 p-2 rounded-md outline-0 backdrop-blur-md" required>
                            ...
                            <option value="Marbles & Stones">Marbles & Stones</option>
                            <option value="Restaurant">Restaurant</option>
                            <option value="Real Estate">Real Estate</option>
                            <option value="NGO (Education)">NGO (Education)</option>
                ...
                <div className="flex flex-col gap-3">
                    ...
                    <textarea name="message" placeholder="How can we help you?" value={formData.message} onChange={handleChange} rows="4" className="border-2 border-zinc-200 focus:border-slate-800 p-2 rounded-md outline-0" required ></textarea>
                </div>

                {/* Submit Button */}
                <button type="submit" className="text-white bg-slate-800 hover:brightness-104 cursor-pointer transition duration-300 py-3 px-8 rounded-md w-full mb-5 font-semibold text-xl place-self-center">Send Message</button>
